...
#include "omegac2main_ana_gain_table_23081.h"
#include "omegac2main_Sensor_setting_23081.h"
...
#define PFX "OMEGAC2MAIN_camera_sensor_23081"
...
#define omegac2main_table_write_cmos_sensor_8(...) subdrv_i2c_wr_regs_u8(__VA_ARGS__)
#define omegac2main_seq_write_cmos_sensor_8(...) subdrv_i2c_wr_seq_p8(__VA_ARGS__)

#define OMEGAC2MAIN_UNIQUE_SENSOR_ID_ADDR_23081 0x3AE8
#define OMEGAC2MAIN_UNIQUE_SENSOR_ID_LENGHT_23081 13
...
static kal_uint8 omegac2main_hw_version = 0;
#endif
static struct oplus_get_eeprom_common_data omegac2main_common_data = {0};
static BYTE omegac2main_unique_id[OMEGAC2MAIN_UNIQUE_SENSOR_ID_LENGHT_23081] = { 0 };

static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = OMEGAC2MAIN_SENSOR_ID_23081,
    ...
    .custom10 = {  //reg_B7 2736x2052 @30FPS QBIN(VBIN)-V2H2 RST= 33.3ms (Tline Max.)
        .pclk = 592800000,
        .linelength = 9232,
        .framelength = 2672,
        .startx = 0,
        .starty = 0,
        .grabwindow_width = 2736,
        .grabwindow_height = 2052,
        .mipi_data_lp2hs_settle_dc = 85,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[] = {
    ...
    {8192, 6144,    0,    0, 8192, 6144, 4096, 3072,
        0,    0, 4096, 3072,  680,  510, 2736, 2052},
...
//omegac2main reg(0x316D 0x316E 0x316F)
...
static struct SENSOR_SETTING_INFO_STRUCT sensor_setting_info[SENSOR_SCENARIO_ID_MAX] = {
        {NORMAL_MASK},    //mode 0 pre
        {NORMAL_MASK},    //mode 1 cap
        {NORMAL_MASK},    //mode 2 video
        {HS_VIDEO_MASK | NORMAL_MASK},    //mode 3 hs
        {SLIM_VIDEO_MASK},    //mode 4 slim
        {SLIM_VIDEO_MASK},    //mode 5 cus1
        {PORTRAIT_MASK},    //mode 6 cus2
        {RMSC_MASK},    //mode 7
        {UNUSE_MASK},    //mode 8
        {INSENSORZOOM_MASK},    //mode 9
        {UNUSE_MASK},     //mode 10
        {UNUSE_MASK},    //mode 11
        {UNUSE_MASK},    //mode 12
        {UNUSE_MASK},    //mode 13
        {PORTRAIT_MASK},    //mode 14
        {UNUSE_MASK},    //mode 15
        {UNUSE_MASK},     //mode 16
        {UNUSE_MASK},     //mode 17
};
...
static void commit_write_sensor(struct subdrv_ctx *ctx)
{
    ...
    if (_size_to_write && !ctx->fast_mode_on) {
        omegac2main_table_write_cmos_sensor_8(ctx, _i2c_data, _size_to_write);
...
static kal_uint16 read_cmos_eeprom_8(struct subdrv_ctx *ctx, kal_uint16 addr)
{
    ...
    adaptor_i2c_rd_u8(ctx->i2c_client, OMEGAC2MAIN_EEPROM_READ_ID_23081 >> 1, addr, (u8 *)&get_byte);
    return get_byte;
}
                   ...
                   BYTE *data, int size)
{
    ...
    if (adaptor_i2c_rd_p8(ctx->i2c_client, OMEGAC2MAIN_EEPROM_READ_ID_23081 >> 1,
                addr, data, size) < 0) {
        return false;
    }
    return true;
        ...
        kal_uint16 addr, kal_uint8 *para, kal_uint32 len)
{
    ...
    ret = adaptor_i2c_wr_p8(ctx->i2c_client, OMEGAC2MAIN_EEPROM_WRITE_ID_23081 >> 1,
            addr, para, len);
...
{
    kal_int32 ret = ERROR_NONE;
    kal_uint16 reg = OMEGAC2MAIN_EEPROM_LOCK_REGISTER_23081;
    if (enable) {
        adaptor_i2c_wr_u8(ctx->i2c_client, OMEGAC2MAIN_EEPROM_WRITE_ID_23081 >> 1,
            reg, (OMEGAC2MAIN_EEPROM_WRITE_ID_23081 & 0xFE) | 0x01);
    }
    else {
        adaptor_i2c_wr_u8(ctx->i2c_client, OMEGAC2MAIN_EEPROM_WRITE_ID_23081 >> 1,
            reg, OMEGAC2MAIN_EEPROM_WRITE_ID_23081 & 0xFE);
    }
...
static kal_int32 eeprom_table_write_23081(struct subdrv_ctx *ctx, kal_uint16 data_base, kal_uint8 *pData, kal_uint16 data_length) {
...
static kal_int32 eeprom_64align_write_23081(struct subdrv_ctx *ctx, kal_uint16 data_base, kal_uint8 *pData, kal_uint16 data_length) {
	...
	if (part1_length) {
		ret = eeprom_table_write_23081(ctx, data_base, pData, part1_length);
		if (ret == -1) {
			/* open write protect */
	...
	msleep(6);
	if (part2_length) {
		ret = eeprom_table_write_23081(ctx, addr_64align, pData + part1_length, part2_length);
		if (ret == -1) {
			/* open write protect */
			write_eeprom_protect(ctx, 1);
            ...
            ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
    ...
    if(pStereodata != NULL) {
        ...
        if ((pStereodata->uSensorId == OMEGAC2MAIN_SENSOR_ID_23081) && (data_length == CALI_DATA_MASTER_LENGTH)
            && (data_base == OMEGAC2MAIN_STEREO_MT_START_ADDR_23081 || data_base == OMEGAC2MAIN_STEREO_MW_START_ADDR_23081)) {

            LOG_INF("omegac2main not write_Module_data, just return ERROR_NONE\n");
            return ERROR_NONE;
/*
            LOG_INF("Write: %x %x %x %x\n", pData[0], pData[39], pData[40], pData[1556]);

            eeprom_64align_write_23081(ctx, data_base, pData, data_length);
...
*/
        } else if ((pStereodata->uSensorId == OMEGAC2MAIN_SENSOR_ID_23081) && (data_length < AESYNC_DATA_LENGTH_TOTAL)
            && (data_base == OMEGAC2MAIN_AESYNC_START_ADDR_23081)) {
            ...
            LOG_INF("readback main aesync: %x %x %x %x %x %x %x %x\n",
                    read_cmos_eeprom_8(ctx, OMEGAC2MAIN_AESYNC_START_ADDR_23081),
                    read_cmos_eeprom_8(ctx, OMEGAC2MAIN_AESYNC_START_ADDR_23081+1),
                    read_cmos_eeprom_8(ctx, OMEGAC2MAIN_AESYNC_START_ADDR_23081+2),
                    read_cmos_eeprom_8(ctx, OMEGAC2MAIN_AESYNC_START_ADDR_23081+3),
                    read_cmos_eeprom_8(ctx, OMEGAC2MAIN_AESYNC_START_ADDR_23081+4),
                    read_cmos_eeprom_8(ctx, OMEGAC2MAIN_AESYNC_START_ADDR_23081+5),
                    read_cmos_eeprom_8(ctx, OMEGAC2MAIN_AESYNC_START_ADDR_23081+6),
                    read_cmos_eeprom_8(ctx, OMEGAC2MAIN_AESYNC_START_ADDR_23081+7));
        ...
        LOG_INF("omegac2main write_Module_data pStereodata is null\n");
        return -1;
    }
    return ret;
}
...
#define omegac2main_QSC_ENABLE_REG 0x3206

#if SEQUENTIAL_WRITE_EN
static kal_uint8 omegac2main_QSC_setting[QSC_SIZE];
#else
static kal_uint16 omegac2main_QSC_setting[QSC_TABLE_SIZE];
#endif
...
#if SEQUENTIAL_WRITE_EN
static kal_uint8 omegac2main_SPC_setting[SPC_SIZE];
#else
static kal_uint16 omegac2main_SPC_setting[SPC_TABLE_SIZE];
#endif
...
static void omegac2main_get_pdaf_reg_setting(struct subdrv_ctx *ctx,
...
static void omegac2main_set_pdaf_reg_setting(struct subdrv_ctx *ctx,
        MUINT32 regNum, kal_uint16 *regDa)
{
    omegac2main_table_write_cmos_sensor_8(ctx, regDa, regNum*2);
}
...
#if SEQUENTIAL_WRITE_EN
        read_cmos_eeprom_p8(ctx, addr_qsc, omegac2main_QSC_setting, QSC_SIZE);
#else
        read_cmos_eeprom_p8(ctx, addr_qsc, tmp_QSC_setting, QSC_SIZE);
        for (idx = 0; idx < QSC_SIZE; idx++) {
        sensor_qsc = QSC_OTP_ADDR + idx;
        omegac2main_QSC_setting[2 * idx] = sensor_qsc;
        omegac2main_QSC_setting[2 * idx + 1] = tmp_QSC_setting[idx];
        }
#endif

//read spc from eeprom
#if SEQUENTIAL_WRITE_EN
        read_cmos_eeprom_p8(ctx, SPC_EEPROM_ADDR, omegac2main_SPC_setting, SPC_SIZE);
#else
        ...
        for (idx = 0; idx < SPC_SIZE_PART1; idx++) {
			...
			omegac2main_QSC_setting[2 * idx] = sensor_qsc;
			omegac2main_QSC_setting[2 * idx + 1] = tmp_SPC_setting[idx];
        }
...
static void read_sensor_verison(struct subdrv_ctx *ctx)
{
	...
	if (chip_value > 2){
		omegac2main_hw_version = HW_MP;
	} else if (chip_value == 2) {
		omegac2main_hw_version = HW_CUT1_0;
	} else if (chip_value == 1) {
		omegac2main_hw_version = HW_CUT0_91;
	} else {
		omegac2main_hw_version = HW_CUT0_90;
	}

	LOG_INF("%s chip_vale(0x%x) hw_version(%d) \n",
		__func__, chip_value, omegac2main_hw_version);
}

static int omegac2main_set_cali_data(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
    u8 *buf = NULL;
    u32 size = 0;
    u8 qsc_is_valid = 0, spc_is_valid = 0;
    u8 type = 0;
    ...
    if (type == 1) {
        ...
        if (size > 0) {
            ...
            if (qsc_is_valid == QSC_IS_VALID_VAL) {
                LOG_INF("QSC data is valid, flag(%02x)", qsc_is_valid);
                if (buf != NULL) {
                    memset(&omegac2main_QSC_setting, 0x00, sizeof(omegac2main_QSC_setting));
                    memcpy(omegac2main_QSC_setting, buf, size);
                    ctx->is_read_preload_eeprom = 2;
                }
                LOG_INF("preload QSC data %u bytes", size);
            } else {
                LOG_INF("QSC data is invalid, flag(%02x)", qsc_is_valid);
            }
        }
    } else if (type == 2) {
        /* LRC/SPC data */
        ...
        buf = para;
        if (size > 0) {
            spc_is_valid = buf[*len];
            if (spc_is_valid == SPC_IS_VALID_VAL) {
                LOG_INF("SPC data is valid, flag(%02x)", spc_is_valid);
                if (buf != NULL) {
                    memset(&omegac2main_SPC_setting, 0x00, sizeof(omegac2main_SPC_setting));
                    memcpy(omegac2main_SPC_setting, buf, size);
                    ctx->is_read_preload_eeprom = 3;
                }
                LOG_INF("preload SPC data %u bytes", size);
            } else {
                LOG_INF("SPC data is invalid, flag(%02x)", spc_is_valid);
            }
        }
    }
    return 0;
...
#if SEQUENTIAL_WRITE_EN
        if (qsc_is_valid == QSC_IS_VALID_VAL) {
            omegac2main_seq_write_cmos_sensor_8(ctx, QSC_OTP_ADDR,
            omegac2main_QSC_setting, sizeof(omegac2main_QSC_setting));
        }
#else
        omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_QSC_setting,
        sizeof(omegac2main_QSC_setting) / sizeof(kal_uint16));
#endif
    }
    write_cmos_sensor_8(ctx, omegac2main_QSC_ENABLE_REG, 0x01);
}
...
static void write_sensor_SPC(struct subdrv_ctx *ctx)
{
	if (spc_is_valid == SPC_IS_VALID_VAL) {
#if SEQUENTIAL_WRITE_EN
		omegac2main_seq_write_cmos_sensor_8(ctx, SPC_OTP_ADDR_PART1,
		omegac2main_SPC_setting, SPC_SIZE_PART1);

		omegac2main_seq_write_cmos_sensor_8(ctx, SPC_OTP_ADDR_PART2,
		 &omegac2main_SPC_setting[SPC_SIZE_PART1], SPC_SIZE_PART2);
#else
		omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_SPC_setting,
			sizeof(omegac2main_SPC_setting) / sizeof(kal_uint16));
#endif
	}
...
static void read_module_data(struct subdrv_ctx *ctx)
{
	...
	memset(&omegac2main_common_data, 0x00, sizeof(omegac2main_common_data));

	omegac2main_common_data.header[EEPROM_MODULE_ID] = 2;
	read_omegac2main_eeprom_info_23081(ctx, EEPROM_META_MODULE_ID,
				&(omegac2main_common_data.data[idx]), 2);
	imgsensor_info.module_id = (kal_uint16)(omegac2main_common_data.data[idx + 1] << 8) |
				   omegac2main_common_data.data[idx];
	idx += omegac2main_common_data.header[EEPROM_MODULE_ID];

	omegac2main_common_data.header[EEPROM_SENSOR_ID] = 2;
	read_omegac2main_eeprom_info_23081(ctx, EEPROM_META_SENSOR_ID,
				&(omegac2main_common_data.data[idx]), 2);
	idx += omegac2main_common_data.header[EEPROM_SENSOR_ID];

	omegac2main_common_data.header[EEPROM_LENS_ID] = 2;
	read_omegac2main_eeprom_info_23081(ctx, EEPROM_META_LENS_ID,
				&(omegac2main_common_data.data[idx]), 2);
	idx += omegac2main_common_data.header[EEPROM_LENS_ID];

	omegac2main_common_data.header[EEPROM_VCM_ID] = 2;
	read_omegac2main_eeprom_info_23081(ctx, EEPROM_META_VCM_ID,
				&(omegac2main_common_data.data[idx]), 2);
	idx += omegac2main_common_data.header[EEPROM_VCM_ID];

	omegac2main_common_data.header[EEPROM_MODULE_SN] = 23;
	read_omegac2main_eeprom_info_23081(ctx, EEPROM_META_MODULE_SN,
				&(omegac2main_common_data.data[idx]), 23);
	idx += omegac2main_common_data.header[EEPROM_MODULE_SN];

	omegac2main_common_data.header[EEPROM_AF_CODE_MACRO] = 2;
	omegac2main_common_data.header[EEPROM_AF_CODE_INFINITY] = 2;
	omegac2main_common_data.header[EEPROM_AF_CODE_MIDDLE] = 2;
	read_omegac2main_eeprom_info_23081(ctx, EEPROM_META_AF_CODE,
				&(omegac2main_common_data.data[idx]), 6);
    ...
    for (idx = 0; idx < 32; idx = idx + 4)
        LOG_INF("In %s:common data: %02x %02x %02x %02x\n", __func__,
               omegac2main_common_data.data[idx], omegac2main_common_data.data[idx + 1],
               omegac2main_common_data.data[idx + 2],
               omegac2main_common_data.data[idx + 3]);

    omegac2main_common_data.data[AF_CODE_MACRO_idx] =
		(kal_uint8)((omegac2main_common_data.data[AF_CODE_MACRO_idx + 1] << 6) | (omegac2main_common_data.data[AF_CODE_MACRO_idx] >> 2));
    omegac2main_common_data.data[AF_CODE_MACRO_idx + 1] = (kal_uint8)(omegac2main_common_data.data[AF_CODE_MACRO_idx +1] >> 2);

    omegac2main_common_data.data[AF_CODE_INFINITY_idx] =
		(kal_uint8)((omegac2main_common_data.data[AF_CODE_INFINITY_idx + 1] << 6) | (omegac2main_common_data.data[AF_CODE_INFINITY_idx] >> 2));
    omegac2main_common_data.data[AF_CODE_INFINITY_idx + 1] = (kal_uint8)(omegac2main_common_data.data[AF_CODE_INFINITY_idx +1] >> 2);

    omegac2main_common_data.data[AF_CODE_MIDDLE_idx] =
		(kal_uint8)((omegac2main_common_data.data[AF_CODE_MIDDLE_idx + 1] << 6) | (omegac2main_common_data.data[AF_CODE_MIDDLE_idx] >> 2));
    omegac2main_common_data.data[AF_CODE_MIDDLE_idx + 1] = (kal_uint8)(omegac2main_common_data.data[AF_CODE_MIDDLE_idx +1] >> 2);
...
kal_uint32 omegac2main_align_shutter(struct subdrv_ctx *ctx, kal_uint32 shutter)
{
	kal_uint32 ret_shutter = 0;
	kal_uint8 binning_type = 0;

	binning_type = read_cmos_sensor_8(ctx, 0x0901);
	switch (binning_type) {
	case 0x44:
		ret_shutter = round_up(shutter + 4, 8) - 4; //8N + 4   V2H2 binnning Vbin/HVbin
		break;
	case 0x11:
		ret_shutter = round_up(shutter, 2);         //2N       full resolution
		break;
	case 0x22:
	default:
		ret_shutter = round_up(shutter + 2, 4) - 2; //4N + 2   binning Vbin/HVbin
		break;
	}
	//LOG_INF("shutter:%d ret_shutter:%d, binning_type:%02x", shutter, ret_shutter, binning_type);
	return ret_shutter;
}

kal_uint32 omegac2main_align_framelength(struct subdrv_ctx *ctx, kal_uint32 framelength)
{
	kal_uint32 ret_framelength = 0;
	kal_uint8 binning_type = 0;

	binning_type = read_cmos_sensor_8(ctx, 0x0901);
	switch (binning_type) {
	case 0x44:
		ret_framelength = round_up(framelength, 8); //8N     V2H2 binnning Vbin/HVbin
		if(ret_framelength > imgsensor_info.max_frame_length) {
			LOG_INF("error framelength");
			ret_framelength = round_down(imgsensor_info.max_frame_length, 8);
		}
		break;
	case 0x11:
		ret_framelength = round_up(framelength, 2); //2N     full resolution
		if(ret_framelength > imgsensor_info.max_frame_length) {
			LOG_INF("error framelength");
			ret_framelength = round_down(imgsensor_info.max_frame_length, 2);
		}
		break;
	case 0x22:
	default:
		ret_framelength = round_up(framelength, 4); //4N     binning Vbin/HVbin
		if(ret_framelength > imgsensor_info.max_frame_length) {
			LOG_INF("error framelength");
			ret_framelength = round_down(imgsensor_info.max_frame_length, 4);
		}
		break;
	}
	//LOG_INF("framelength:%d ret_framelength:%d, binning_type:%02x", framelength, ret_framelength, binning_type);

	return ret_framelength;
}
...
static void set_max_framerate(struct subdrv_ctx *ctx, UINT16 framerate, kal_bool min_framelength_en)
{
    ...
    if (frame_length >= ctx->min_frame_length) {
        ...
        ctx->frame_length = omegac2main_align_framelength(ctx, ctx->frame_length);
    }
    else
...
static void write_shutter(struct subdrv_ctx *ctx, kal_uint32 shutter, kal_bool gph)
{
    ...
    shutter = omegac2main_align_shutter(ctx, shutter);
                ...
                kal_uint16 frame_length)
{
    ...
    for (i = 0; i < shutter_cnt; i++) {
        ...
        shutters[i] = omegac2main_align_shutter(ctx, shutters[i] / shutter_cnt) * shutter_cnt;
    }
    ...
    if(ctx->frame_length > ctx->min_frame_length) {
        ctx->frame_length = omegac2main_align_framelength(ctx, ctx->frame_length);
    }
...
{
    LOG_INF("E omegac2main_hw_version(%d)\n", omegac2main_hw_version);

    omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_init_setting_23081,
        sizeof(omegac2main_init_setting_23081)/sizeof(kal_uint16));
...
{
    LOG_INF("E\n");
    omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_preview_setting,
        sizeof(omegac2main_preview_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, omegac2main_QSC_ENABLE_REG, 0x00);
    }
    LOG_INF("X\n");
}
...
{
    LOG_INF("E\n");
    omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_capture_setting,
        sizeof(omegac2main_capture_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, omegac2main_QSC_ENABLE_REG, 0x00);
...
{
    LOG_INF("E\n");
    omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_normal_video_setting,
        sizeof(omegac2main_normal_video_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, omegac2main_QSC_ENABLE_REG, 0x00);
...
{
    LOG_INF("E\n");
    omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_hs_video_setting,
        sizeof(omegac2main_hs_video_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, omegac2main_QSC_ENABLE_REG, 0x00);
...
{
    LOG_INF("E\n");
    omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_slim_video_setting,
        sizeof(omegac2main_slim_video_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, omegac2main_QSC_ENABLE_REG, 0x00);
...
{
    LOG_INF("E\n");
    omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_custom1_setting,
        sizeof(omegac2main_custom1_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, omegac2main_QSC_ENABLE_REG, 0x00);
...
{
    LOG_INF("E\n");
    omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_custom2_setting,
        sizeof(omegac2main_custom2_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, omegac2main_QSC_ENABLE_REG, 0x00);
...
{
    LOG_INF("E\n");
    omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_custom3_setting,
        sizeof(omegac2main_custom3_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, omegac2main_QSC_ENABLE_REG, 0x00);
...
{
    LOG_INF("E\n");
    omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_custom4_setting,
        sizeof(omegac2main_custom4_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, omegac2main_QSC_ENABLE_REG, 0x00);
...
{
    LOG_INF("E\n");
    omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_custom5_setting,
        sizeof(omegac2main_custom5_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, omegac2main_QSC_ENABLE_REG, 0x00);
...
{
    LOG_INF("E\n");
    omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_custom6_setting,
        sizeof(omegac2main_custom6_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, omegac2main_QSC_ENABLE_REG, 0x00);
...
{
    LOG_INF("E\n");
    omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_custom7_setting,
        sizeof(omegac2main_custom7_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, omegac2main_QSC_ENABLE_REG, 0x00);
...
{
    LOG_INF("E\n");
    omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_custom8_setting,
        sizeof(omegac2main_custom8_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, omegac2main_QSC_ENABLE_REG, 0x00);
...
{
    LOG_INF("E\n");
    omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_custom9_setting,
        sizeof(omegac2main_custom9_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, omegac2main_QSC_ENABLE_REG, 0x00);
...
{
    LOG_INF("E\n");
    omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_custom10_setting,
        sizeof(omegac2main_custom10_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, omegac2main_QSC_ENABLE_REG, 0x00);
...
{
    LOG_INF("E\n");
    omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_custom11_setting,
        sizeof(omegac2main_custom11_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, omegac2main_QSC_ENABLE_REG, 0x00);
        ...
        kal_uint32 le, kal_uint32 me, kal_uint32 se, kal_bool gph)
{
    ...
    if (le) {
        ...
        le = omegac2main_align_shutter(ctx, le / exposure_cnt) * exposure_cnt;
    }
    if (me) {
        me = (kal_uint16)max(imgsensor_info.min_shutter, (kal_uint32)me);
        me = omegac2main_align_shutter(ctx, me / exposure_cnt) * exposure_cnt;
    }
    if (se) {
        se = (kal_uint16)max(imgsensor_info.min_shutter, (kal_uint32)se);
        se = omegac2main_align_shutter(ctx, se / exposure_cnt) * exposure_cnt;
    }

    if((kal_uint32)(le + me + se + imgsensor_info.margin*exposure_cnt*exposure_cnt) > ctx->min_frame_length) {
        ctx->frame_length = (kal_uint32)(le + me + se + imgsensor_info.margin*exposure_cnt*exposure_cnt);
        ctx->frame_length = omegac2main_align_framelength(ctx, ctx->frame_length);
    } else {
        ctx->frame_length = ctx->min_frame_length;
    }
...
unsigned short omegac2main_seamless_preview_Optimize1_23081[] = {
    0x38B0,0x00,
    0x38B1,0x00,
    0x38B2,0x00,
    0x38B3,0x00,
...
unsigned short omegac2main_seamless_custom5_Optimize1_23081[] = {
    0x38B0,0x00,
    0x38B1,0x86,
    0x38B2,0x00,
    0x38B3,0x86,
        ...
        enum SENSOR_SCENARIO_ID_ENUM scenario_id, uint32_t *ae_ctrl)
{
    ...
    {
        unsigned short omegac2main_seamless_custom7[] = {
            0x0340, 0x12,
            0x0341, 0xBA,
            0x0202, 0x12,
            0x0203, 0x8A,
        ...
        FMC_GPH_START;
        omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_seamless_custom7,
                sizeof(omegac2main_seamless_custom7) / sizeof(kal_uint16));
    ...
    {
        unsigned short omegac2main_seamless_custom8[] = {
            0x0340, 0x09,
            0x0341, 0x5C,
            0x0202, 0x07,
            0x0203, 0xE0,
        ...
        FMC_GPH_START;
        omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_seamless_custom8,
                sizeof(omegac2main_seamless_custom8) / sizeof(kal_uint16));
    ...
    case SENSOR_SCENARIO_ID_CUSTOM5:
    {
        ...
        FMC_GPH_START;
        omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_seamless_custom5_23081,
                sizeof(omegac2main_seamless_custom5_23081) / sizeof(kal_uint16));
        ...
        omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_seamless_custom5_Optimize1_23081, sizeof(omegac2main_seamless_custom5_Optimize1_23081)/sizeof(kal_uint16));
        FMC_GPH_END;
    }
        break;
    case SENSOR_SCENARIO_ID_NORMAL_PREVIEW:
    {
        ...
        FMC_GPH_START;
        omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_seamless_normal_preview_23081,
                 sizeof(omegac2main_seamless_normal_preview_23081) / sizeof(kal_uint16));
        ...
        omegac2main_table_write_cmos_sensor_8(ctx, omegac2main_seamless_preview_Optimize1_23081, sizeof(omegac2main_seamless_preview_Optimize1_23081)/sizeof(kal_uint16));
        FMC_GPH_END;
    }
        break;
...
static void read_unique_sensorid(struct subdrv_ctx *ctx)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xFF) {
        ...
        adaptor_i2c_rd_p8(ctx->i2c_client, ctx->i2c_write_id >> 1,
            OMEGAC2MAIN_UNIQUE_SENSOR_ID_ADDR_23081, &(omegac2main_unique_id[0]), OMEGAC2MAIN_UNIQUE_SENSOR_ID_LENGHT_23081);
        i++;
    }
}

static void omegac2main_get_unique_sensorid(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
    u32 *feature_return_para_32 = (u32 *)para;
    *len = OMEGAC2MAIN_UNIQUE_SENSOR_ID_LENGHT_23081;
    LOG_INF("get unique sensorid");
    memcpy(feature_return_para_32, omegac2main_unique_id,
        OMEGAC2MAIN_UNIQUE_SENSOR_ID_LENGHT_23081);
    LOG_INF("para :%x, get unique sensorid", *para);
}

static void omegac2main_get_eeprom_probe_state(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
    int *eeprom_probe_state = (int*)para;
    *eeprom_probe_state = omegac2main_read_eeprom_state_23081(ctx);
}
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = ((read_cmos_sensor_8(ctx, 0x0016) << 8)
            ...
            if (*sensor_id == OMEGAC2MAIN_SENSOR_ID || *sensor_id == OMEGAC2MAIN_SENSOR_ID_2) {
...
static int open(struct subdrv_ctx *ctx)
{
    ...
    LOG_INF("OMEGAC2MAIN open Start\n");
        ...
        enum SENSOR_SCENARIO_ID_ENUM scenario_id, MUINT32 framerate)
{
    ...
    ctx->frame_length = omegac2main_align_framelength(ctx, ctx->frame_length);
    ctx->min_frame_length = omegac2main_align_framelength(ctx, ctx->min_frame_length);
    set_dummy(ctx);
    return ERROR_NONE;
}
...
static kal_uint8 omegac2main_feedback_awbgain[] = {
    0x01, 0x00,
    0x02, 0x28,
    0x01, 0x77,
    0x01, 0x00,
...
static void feedback_awbgain(struct subdrv_ctx *ctx, kal_uint32 r_gain, kal_uint32 b_gain)
{
    ...
    omegac2main_feedback_awbgain[2] = r_gain_int;
    omegac2main_feedback_awbgain[3] = (r_gain - r_gain_int * 512) / 2;
    omegac2main_feedback_awbgain[4] = b_gain_int;
    omegac2main_feedback_awbgain[5] = (b_gain - b_gain_int * 512) / 2;
    write_cmos_sensor_8(ctx, 0x0B8E, omegac2main_feedback_awbgain[0]);
    write_cmos_sensor_8(ctx, 0x0B8F, omegac2main_feedback_awbgain[1]);
    write_cmos_sensor_8(ctx, 0x0b90, omegac2main_feedback_awbgain[2]);
    write_cmos_sensor_8(ctx, 0x0b91, omegac2main_feedback_awbgain[3]);
    write_cmos_sensor_8(ctx, 0x0b92, omegac2main_feedback_awbgain[4]);
    write_cmos_sensor_8(ctx, 0x0b93, omegac2main_feedback_awbgain[5]);
    write_cmos_sensor_8(ctx, 0x0B94, omegac2main_feedback_awbgain[6]);
    write_cmos_sensor_8(ctx, 0x0B95, omegac2main_feedback_awbgain[7]);
}
...
//    struct SENSOR_VC_INFO2_STRUCT *pvcinfo2;
    ...
    case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
        if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
            *(feature_data + 0) =
                sizeof(omegac2main_ana_gain_table_23081);
        } else {
            memcpy((void *)(uintptr_t) (*(feature_data + 1)),
            (void *)omegac2main_ana_gain_table_23081,
            sizeof(omegac2main_ana_gain_table_23081));
        }
        break;
    ...
    case SENSOR_FEATURE_GET_EEPROM_COMDATA:
        if(*feature_para_len == sizeof(omegac2main_common_data) && feature_return_para_32 != feature_para_len) {
            memcpy(feature_return_para_32, &omegac2main_common_data,
                sizeof(omegac2main_common_data));
        }
        break;
...
/*
        ...
        case EEPROM_STEREODATA_MT_MAIN:
            read_omegac2main_eeprom_info_23081(ctx, EEPROM_META_STEREO_MT_MAIN_DATA,
                    (BYTE *)feature_return_para_32, *feature_para_len);
            break;
        case EEPROM_STEREODATA_MW_MAIN:
        default:
            read_omegac2main_eeprom_info_23081(ctx, EEPROM_META_STEREO_MW_MAIN_DATA,
                    (BYTE *)feature_return_para_32, *feature_para_len);
            break;
        }
        break;
...
#define EEPROM_8k 0x8000
    case SENSOR_FEATURE_GET_SENSOR_OTP_ALL:
        ...
        read_omegac2main_eeprom_23081(ctx, 0x00, (BYTE *)feature_return_para_32, *feature_para_len);
    break;
    ...
    case SENSOR_FEATURE_GET_PDAF_INFO:
        ...
        case SENSOR_SCENARIO_ID_HIGHSPEED_VIDEO:
            ...
            break;
        case SENSOR_SCENARIO_ID_CUSTOM10:  // 2736*2052 custom10
            memcpy((void *)PDAFinfo, (void *)&imgsensor_partial_pd_info,
                sizeof(struct SET_PD_BLOCK_INFO_T));
            PDAFinfo->i4BlockNumX = 342;
            PDAFinfo->i4BlockNumY = 128;
            break;
        default :
...
//        get_vc_info_2(pvcinfo2, *feature_data_32);
    ...
    case SENSOR_FEATURE_GET_STAGGER_MAX_EXP_TIME:
        if (*feature_data == SENSOR_SCENARIO_ID_CUSTOM1) {
            // see OMEGAC2MAIN SRM, table 5-22 constraints of COARSE_INTEG_TIME
            switch (*(feature_data + 1)) {
            case VC_STAGGER_NE:
            case VC_STAGGER_ME:
            case VC_STAGGER_SE:
    ...
    case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
        LOG_DEBUG("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
            (*feature_para_len));
        omegac2main_get_pdaf_reg_setting(ctx, (*feature_para_len) / sizeof(UINT32)
                       , feature_data_16);
        break;
    case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
        omegac2main_set_pdaf_reg_setting(ctx, (*feature_para_len) / sizeof(UINT32)
                       , feature_data_16);
        break;
    ...
    case SENSOR_FEATURE_GET_BINNING_TYPE:
        *feature_return_para_32 = 1;
        LOG_INF("OMEGAC2MAIN SENSOR_FEATURE_GET_BINNING_TYPE AE_binning_type:%d,\n",
    ...
    case SENSOR_FEATURE_GET_UNIQUE_SENSORID:
        omegac2main_get_unique_sensorid(ctx, feature_para, feature_para_len);
        break;
    case SENSOR_FEATURE_SET_CALI_DATA:
        omegac2main_set_cali_data(ctx, feature_para, feature_para_len);
        break;
    case SENSOR_FEATURE_GET_EEPROM_PROBE_STATE:
        omegac2main_get_eeprom_probe_state(ctx, feature_para, feature_para_len);
        break;
...
const struct subdrv_entry omegac2main_mipi_raw_23081_entry = {
    .name = "omegac2main_mipi_raw_23081",
    .id = OMEGAC2MAIN_SENSOR_ID_23081,
    .pw_seq = pw_seq,
